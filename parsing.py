...
from days_except import ParceDaysExceptions, WrongFormatDate,\
    WeekNumberError, WeekDayNameError, \
    MonthNameError
from log_saver import Log

__all__ = ['TextToDate']


class TextToDate:
    _MONTHS = {'янв': 1, 'фев': 2, 'мар': 3, 'апр': 4, 'май': 5, 
    'июн': 6,'июл': 7, 'авг': 8, 'сен': 9, 'окт': 10, 'ноя': 11, 'дек': 12,}

    _WEEK_DAYS = {'понедельник': 0, 'вторник': 1, 'среда': 2, 
    ...
    def date(self) -> datetime:
                return self._date_valuelf._message
