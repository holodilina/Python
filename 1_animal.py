...
from Task_002_a import Mammal, Bird, Fish, Animal
class AnimalFabric:
    _tmp_parameters = {}
...
def main():
    dog = AnimalFabric.build(animal_type = 'Mammal',
                                name = 'Fido', 
                                age = 5, 
                                voice = 'Woof!',
                                hair = 'Pale, long')
    fish = AnimalFabric.build(animal_type = 'Fish',
                                name = 'Vanda',
                                age = 1,
                                color = 'Rainbow')
    bird = AnimalFabric.build(animal_type = 'Bird',
                                name = 'Carl',
                                age = 8,
                                color = 'Black',
                                voice = 'CRAW!')
    unidentified = AnimalFabric.build(animal_type = 'Non - type',
                                    name = 'Fail - Tester',
                                    age = 100,
                                    color = 'Green',
                                    voice = 'Boo',
